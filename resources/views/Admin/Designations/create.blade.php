    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col">
                ...
                <p class="text-muted mb-0">Create a new job title or position</p>
            </div>
            <div class="col-auto">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm @error('code') is-invalid @enderror" 
                                   id="code" name="code" value="{{ old('code') }}" placeholder="e.g., SR-DEV, HR-MGR" required>
                            @error('code')
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm @error('title') is-invalid @enderror" 
                                   id="title" name="title" value="{{ old('title') }}" placeholder="e.g., Senior Developer" required>
                            @error('title')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" id="grade" name="grade" 
                                   value="{{ old('grade') }}" placeholder="e.g., L3, Grade 1">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control form-control-sm" id="min_salary" name="min_salary" 
                                   value="{{ old('min_salary') }}" placeholder="50000">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control form-control-sm" id="max_salary" name="max_salary" 
                                   value="{{ old('max_salary') }}" placeholder="150000">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control form-control-sm" id="description" name="description" rows="3" 
                                      placeholder="Job description, responsibilities...">{{ old('description') }}</textarea>
                        </div>
                    </div>
