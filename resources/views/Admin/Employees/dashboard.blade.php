...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-header bg-light py-3">
                    <h6 class="mb-0"><i class="fas fa-bell mr-2"></i>Recent Announcements</h6>
                </div>
                    ...
                    <div class="list-group-item px-3 py-2">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <p class="small text-muted mb-0">{{ $announcement->content }}</p>
                            </div>
                            <small class="text-muted">{{ $announcement->publish_date->format('d M') }}</small>
                        </div>
                    </div>
                    @empty
