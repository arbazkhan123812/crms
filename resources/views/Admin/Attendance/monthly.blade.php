    ...
    <div class="content">
        <div class="page-header mb-4">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <div class="d-flex">
                        <select class="form-control select2 form-control-sm ml-2" style="width: 120px;" id="monthSelect">
                        ...
                        <select class="form-control select2 form-control-sm ml-2" style="width: 100px;" id="yearSelect">
                            @foreach(range(date('Y') - 10, date('Y') + 5) as $y)
                                <option value="{{ $y }}" {{ $year == $y ? 'selected' : '' }}>{{ $y }}</option>
                            @endforeach
                        </select>
                        <a href="{{ route('admin.attendance.index') }}" style="width: 150px;" class="btn btn-primary btn-sm">
                    ...
                    <table class="table table-bordered mb-0" id="attendanceTable">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th colspan="{{ Carbon\Carbon::createFromDate($year, $month, 1)->daysInMonth }}"
                                    class="text-center">Days of Month</th>
                                ...
                                <th rowspan="2" class="align-middle text-center" style="min-width: 80px;">Leave</th>
                            ...
                            @forelse($employees as $employee)
                                <tr>
                                    <td>
                                        ...
                                        <div class="small text-info">{{ $employee->designation->title ?? 'No Designation' }}
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center font-weight-bold">{{ $leave }}</td>
