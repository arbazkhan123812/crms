...
<div class="content">
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col">
                ...
                <p class="text-muted mb-0">Track employee attendance for {{ Carbon\Carbon::parse($date)->format('d F, Y') }}</p>
            </div>
            <div class="col-auto">
                <div class="d-flex">
                    <div class="btn-group mr-2">
                        <a href="{{ route('admin.attendance.index', ['date' => Carbon\Carbon::parse($date)->subDay()->format('Y-m-d')]) }}" class="btn btn-primary btn-sm">
                            <i class="fas fa-chevron-left"></i>
                        </a>
                        <input type="date" class="form-control form-control-sm" style="width: 150px;" value="{{ $date }}" id="datePicker">
                        <a href="{{ route('admin.attendance.index', ['date' => Carbon\Carbon::parse($date)->addDay()->format('Y-m-d')]) }}" class="btn btn-primary btn-sm">
    ...
    <div class="card">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    @if($att->employee->profile_image)
                                        <img src="{{ asset('storage/'.$att->employee->profile_image) }}" class="rounded-circle mr-2" width="32" height="32">
                                    @else
                        ...
                        <tr>
                            <td colspan="9" class="text-center py-5">
                                ...
                                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#markAttendanceModal">
                                    <i class="fas fa-plus mr-1"></i> Mark Attendance
                                </button>
                            </td>
                        </tr>
        ...
        <div class="card-footer bg-white py-3">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="text-muted small mb-0">Showing {{ $attendances->firstItem() ?? 0 }} to {{ $attendances->lastItem() ?? 0 }} of {{ $attendances->total() }} entries</p>
                </div>
                <div class="col-md-6">
            ...
            <form action="{{ route('admin.attendance.update') }}" method="POST" id="editAttendanceForm">
                ...
                <div class="modal-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm bg-light" id="edit_employee_name" readonly>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="time" class="form-control form-control-sm" name="check_in" id="edit_check_in" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label">Check Out Time</label>
                                <input type="time" class="form-control form-control-sm" name="check_out" id="edit_check_out" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-check mb-3">
                                <input type="checkbox" class="form-check-input" name="is_late" id="edit_is_late" value="1">
                                <label class="form-check-label" for="edit_is_late">Mark as Late</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check mb-3">
                                <input type="checkbox" class="form-check-input" name="is_overtime" id="edit_is_overtime" value="1">
                                <label class="form-check-label" for="edit_is_overtime">Include Overtime</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3" id="edit_remarks_field" style="display: none;">
                        ...
                        <textarea class="form-control form-control-sm" name="remarks" id="edit_remarks" rows="2" placeholder="Reason for half day/leave..."></textarea>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('admin.attendance.mark') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label">Date</label>
                        <input type="date" class="form-control form-control-sm" name="date" value="{{ $date }}" required>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
...
function editAttendance(att) {
    ...
    // Format time values (assuming check_in and check_out are in datetime format)
    ...
    // Set checkboxes
    $('#edit_is_late').prop('checked', attendance.is_late ? true : false);
    $('#edit_is_overtime').prop('checked', attendance.is_overtime ? true : false);
...
// Handle form submission via AJAX (optional - for better UX)
