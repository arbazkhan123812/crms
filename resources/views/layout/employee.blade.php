...
<body class="hidden-navigation">
    ...
    <div class="layout-wrapper">
        ...
        @include('_global.Employee.Header') <!-- Content wrapper -->
        <div class="content-wrapper">
            @include('_global.Employee.Navigation') <!-- Content body -->
            <div class="content-body">
                ...
                @include('_global.Employee.Footer')
            </div>
            <!-- ./ Content body -->
        </div>
        <!-- ./ Content wrapper -->
