...
Route::prefix('admin')->name('admin.')->middleware(['auth'])->group(function () {
    ...
    Route::get('/crm/{entityType}/{entityId}/notes', [EntityActivityController::class, 'getNotes'])->name('crm.notes.index');
    Route::post('/crm/{entityType}/{entityId}/notes', [EntityActivityController::class, 'addNote'])->name('crm.notes.store');
    Route::put('/crm/notes/{id}', [EntityActivityController::class, 'updateNote'])->name('crm.notes.update');
    Route::delete('/crm/notes/{id}', [EntityActivityController::class, 'deleteNote'])->name('crm.notes.delete');
    Route::get('/crm/{entityType}/{entityId}/tasks', [EntityActivityController::class, 'getTasks'])->name('crm.tasks.index');
    Route::post('/crm/{entityType}/{entityId}/tasks', [EntityActivityController::class, 'addTask'])->name('crm.tasks.store');
    Route::put('/crm/tasks/{id}', [EntityActivityController::class, 'updateTask'])->name('crm.tasks.update');
    Route::put('/crm/tasks/{id}/status', [EntityActivityController::class, 'updateTaskStatus'])->name('crm.tasks.status');
    Route::delete('/crm/tasks/{id}', [EntityActivityController::class, 'deleteTask'])->name('crm.tasks.delete');
    Route::get('/crm/{entityType}/{entityId}/calls', [EntityActivityController::class, 'getCalls'])->name('crm.calls.index');
    Route::post('/crm/{entityType}/{entityId}/calls', [EntityActivityController::class, 'addCall'])->name('crm.calls.store');
    Route::put('/crm/calls/{id}', [EntityActivityController::class, 'updateCall'])->name('crm.calls.update');
    Route::delete('/crm/calls/{id}', [EntityActivityController::class, 'deleteCall'])->name('crm.calls.delete');
    Route::get('/crm/{entityType}/{entityId}/meetings', [EntityActivityController::class, 'getMeetings'])->name('crm.meetings.index');
    Route::post('/crm/{entityType}/{entityId}/meetings', [EntityActivityController::class, 'addMeeting'])->name('crm.meetings.store');
    Route::put('/crm/meetings/{id}', [EntityActivityController::class, 'updateMeeting'])->name('crm.meetings.update');
    Route::post('/crm/meetings/{id}/complete', [EntityActivityController::class, 'completeMeeting'])->name('crm.meetings.complete');
    Route::delete('/crm/meetings/{id}', [EntityActivityController::class, 'deleteMeeting'])->name('crm.meetings.delete');
